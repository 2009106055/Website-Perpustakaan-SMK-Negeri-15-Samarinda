...
$member = queryReadData("SELECT * FROM member LIMIT $awalData, $JumlahDataPerHalaman");
...
<html lang="en">
  ...
  <body>
    ...
    <div class="p-4 mt-5">
     ...
     <form action="" method="post" class="mt-5">
      ...
      <tr>
        ...
        <td>
          <div class="action">
             <a href="deleteMember.php?id=<?= $item["nisn"]; ?>" class="btn btn-danger" onclick="return confirm('Yakin ingin menghapus data member ?');"><i class="fa-solid fa-trash"></i>delete</a>
           </div>
        </td>
       </tr>
      <?php endforeach;?>
    ...
    <footer class="fixed-bottom shadow-lg bg-subtle p-3">
      ...
      <p class="mt-2">Created by <span class="text-primary"> Muhammad Alfarezy Cannavaro</span> © 2024</p>
