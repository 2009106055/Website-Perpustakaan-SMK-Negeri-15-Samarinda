...
<html lang="en">
  <head>
    ...
    <title>PerpustakaanSMKNegeri15Samarinda.com</title>
  ...
  <div class="container-fluid">
    <img src="assets/LOGO 2.png" alt="logo" width="280px">
    ...
    <section id="homeSection" class="p-5">
      <div class="d-flex flex-wrap justify-content-center">
        <div class="col mt-5">
         <h2 class="fw-bold text-success"><span class="text-primary">Perpustakaan</span> SMK NEGERI 15 SAMARINDA</h2>
          <p class="mb-4">"Temukan Dunia Pengetahuan di Ujung Jari Anda: <br> Perpustakaan Online <span class="fw-bold">SMK Negeri 15 Samarinda</span> Membawa Anda ke Dunia Buku Digital."</p>
    ...
    <div class="d-flex justify-content-center flex-wrap gap-4 mt-4">
      <div class="card border-info mb-3" style="max-width: 18rem;">
        <div class="card-header">Muhammad Alfarezy Cannavaro</div>
        <div class="card-body">
          <h5 class="card-title">Student At Universitas Mulawarman</h5>
        </div>
      </div>
    </div>
    </section>
    ...
    <footer id="footer" class="p-3 bg-dark">
      ...
      <div class="row p-3">
        <div class="col mt-3">
          ...
          <p class="text-secondary fs-6">Jl. Ringroad No.15, RT.15/RW.04, Lok Bahu, Kec. Sungai Kunjang, Kota Samarinda, Kalimantan Timur 75125</p>
        </div>
        ...
        <div class="d-flex justify-content-center align-items-center mt-3">
          <p class="text-light">Made width  <a href="" class="text-decoration-none">Muhammad Alfarezy Cannavaro</a>  2024</p>
        </div>
      </div>
    </footer>
